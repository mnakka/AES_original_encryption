...
--Date        : Wed Apr 12 15:55:11 2017
--Host        : spock.ece.unm.edu running 64-bit Red Hat Enterprise Linux Workstation release 6.4 (Santiago)
...
begin
   ...
   TopMod: component Top
      port map (Clk=>FCLK_CLK0, GPIO_Ins=>GPIO_Outs, GPIO_Outs=>GPIO_Ins, Scope_trigger=>Scope_trigger, RESET_N_EXT=>FCLK_RESET0_N);
